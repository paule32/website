...
<html lang="en">
  ...
  <body>
    ...
    <div id="siteheader">
	    ...
	    <div id="logobar">
	        ...
	        <div id="startfree">
                <script type="text/javascript">
                function startRAD() {
                    var cookie = getCookie("radcookie");
                    if (cookie == "" && cookie.length < 1 || cookie == null) {
                        alert("cookies müssen aktiviert sein !!!");
                    }   window.location.href = "/boot.php";
                }
                </script>
    		    <div class="okButton" onclick="startRAD()">Start FREE</div>
		    </div>
	    </div>
    	<div id="apache2"></div>
    </div>
	<div id="welcome">
		<div id="banner">
		    <div id="motto">
        		<div id="mottohead">Rapid Application Development (RAD)</div>
		    ...
		    <div id="cookies">
                ...
                <script type="text/javascript">
                    function cookieClickOk() {
                        ...
                        style.display = "none";
                        setCookie("radcookie","set",30);
                    }
                    var cookie  = getCookie("radcookie");
                    if (cookie == "" && cookie.length < 1) {
       			        document.write("Diese Webseite verwendet Cokkie.");
    			        document.write("Mit der Nutzung stimmen Sie der Verwendung von Cookies zu");
                        document.write("<div class='okButton' onclick='cookieClickOk();'>Ok</div>");
    			        document.write("<div class='okButton' onclick='cookieLearn();'>Learn More</div>");
                    }
                    else {
                        document.getElementById("cookies").
                        style.display = "none";
